...
C_SRCS += \
../azure-rtos/threadx/ports/common/tx_initialize_low_level.c 

C_DEPS += \
./azure-rtos/threadx/ports/common/tx_initialize_low_level.d 

OBJS += \
./azure-rtos/threadx/ports/common/tx_initialize_low_level.o 


# Each subdirectory must supply rules for building sources it contributes
azure-rtos/threadx/ports/common/%.o: ../azure-rtos/threadx/ports/common/%.c azure-rtos/threadx/ports/common/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-azure-2d-rtos-2f-threadx-2f-ports-2f-common

clean-azure-2d-rtos-2f-threadx-2f-ports-2f-common:
	-$(RM) ./azure-rtos/threadx/ports/common/tx_initialize_low_level.d ./azure-rtos/threadx/ports/common/tx_initialize_low_level.o

.PHONY: clean-azure-2d-rtos-2f-threadx-2f-ports-2f-common
