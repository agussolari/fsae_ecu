...
#define PIO1_2_FUNC_ALT1 0x01u        /*!<@brief Selects pin function.: Alternative connection 1. */
#define PIO1_3_DIGIMODE_DIGITAL 0x01u /*!<@brief Select Digital mode.: Enable Digital mode. Digital input is enabled. */
#define PIO1_3_FUNC_ALT1 0x01u        /*!<@brief Selects pin function.: Alternative connection 1. */

/*! @name FC0_RXD_SDA_MOSI_DATA (number 61), UART_RX
  @{ */
/* @} */

/*! @name FC0_TXD_SCL_MISO_WS (number 63), UART_TX
  @{ */
/* @} */

/*! @name ADC0_0 (number 12), ADC_THROTTLE
  @{ */
/* @} */

/*! @name CAN0_RD (number 42), CAN_RX
  @{ */
/* @} */

/*! @name CAN0_TD (number 41), CAN_TX
  @{ */
/* @} */
